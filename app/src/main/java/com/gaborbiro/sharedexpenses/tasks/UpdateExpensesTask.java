...
public class UpdateExpensesTask extends BaseExpensesTask<ExpenseItem, Integer> {
    ...
    @Inject
    public UpdateExpensesTask(AppPrefs appPrefs, UserPrefs userPrefs, GoogleApiScreen googleApiScreen, ProgressScreen progressScreen, MainScreen mainScreen, ExpenseApi expenseApi) {
