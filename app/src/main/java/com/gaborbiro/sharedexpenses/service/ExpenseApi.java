...
public class ExpenseApi {
    ...
    public ExpenseApi(GoogleAccountCredential credential) {
    ...
    public ExpenseItem[] getExpenses() throws IOException {
        ...
        if (values != null && values.size() > 1) {
            try {
                Builder builder = new Builder(values.get(0));
    ...
    public int insertExpense(ExpenseItem expense) throws IOException {
        ...
        AppendValuesResponse response = sheetsApi.spreadsheets().values().
